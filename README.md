...
| [KDS.md](KDS.md) | KDS (οθόνη κουζίνας): φίλτρα ανά πόστο (Profiles/Κατηγορίες/Προέλευση), σήμανση ειδών, «Έτοιμη»/«Παράδοση», συγχρονισμός με Ροή, οθόνη προτεραιότητας πελατών |
| [KIOSK.md](KIOSK.md) | Kiosk (αυτοεξυπηρέτηση): ενεργοποίηση/στήσιμο, πληρωμή-πρώτα με κάρτα, εκκρεμείς πληρωμές, πώς φαίνεται σε Ροή/KDS/εκτυπώσεις |
