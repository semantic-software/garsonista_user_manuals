...
- **Cloud Ταμειακή**: άνοιξε την εφαρμογή και συνδέσου με τα στοιχεία του
  καταστήματος που έχει δώσει η Garsonista. Για να τυπώνει αποδείξεις, πρέπει
  να εγκατασταθεί στο PC ο driver του θερμικού εκτυπωτή (**TP80K** — HPRT και
  κλασικοί POS80) και να δηλωθεί ο εκτυπωτής στο Garsonista — δες αναλυτικά,
  βήμα-βήμα με εικόνες, το εγχειρίδιο
  [PRINTER_DRIVER_TP80K.md](PRINTER_DRIVER_TP80K.md).
